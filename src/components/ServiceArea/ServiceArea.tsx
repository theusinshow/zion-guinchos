  ...
  return (
    <section data-section="area-de-atendimento" id="area-de-atendimento" className={styles.section} aria-labelledby="area-title">
      ...
      <div className={styles.right}>
        <svg className={styles.mapDesktop} viewBox="0 0 760 740" role="img" aria-label={MAP_LABEL}>
        ...
        <svg className={styles.mapMobile} viewBox="0 0 350 360" role="img" aria-label={MAP_LABEL}>
