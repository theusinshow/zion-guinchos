...
export type TrackPlacement = 'header' | 'hero' | 'urgent_cta' | 'area' | 'final' | 'footer' | 'menu' | 'action_bar'
...
const PLACEMENTS: readonly TrackPlacement[] = ['header', 'hero', 'urgent_cta', 'area', 'final', 'footer', 'menu', 'action_bar']
